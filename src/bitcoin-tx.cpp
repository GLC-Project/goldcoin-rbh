...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " goldcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  goldcoin-tx [options] <hex-tx> [commands]  Update hex-encoded goldcoin transaction\n" +
            "or:     goldcoin-tx [options] -create [commands]   Create hex-encoded goldcoin transaction\n" +
            "\n";
