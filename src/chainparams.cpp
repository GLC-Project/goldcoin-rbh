...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-rbh1.goldcoin.org");
        vSeeds.emplace_back("seed-rbh2.goldcoin.org");
        ...
        base58Prefixes[SECRET_KEY2] =     std::vector<unsigned char>(1,128);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-rbh1.goldcoin.org");
